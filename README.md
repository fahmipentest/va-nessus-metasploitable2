...
---
💡 Key Takeaways
Selalu mulai dengan Host Discovery untuk memetakan attack surface
Advanced Scan lebih efisien dari Basic Scan (1 jam vs 4 jam, Critical lebih banyak)
Web Application Tests wajib dijalankan terpisah untuk web findings yang komprehensif
Credentialed scan akan menemukan jauh lebih banyak vulnerability
Kombinasi terbaik: Advanced Scan + Web Application Tests + Credentialed Scan
Nessus Essentials sangat efektif untuk home lab meski ada keterbatasan export
---
🧰 Tools Used
Tool	Purpose
Nessus Essentials	Vulnerability Scanner
Kali Linux	Attacker Machine / Scanner Host
...
![GitHub](https://img.shields.io/badge/GitHub-fahmipentest-181717?style=flat-square&logo=github)
---
<div align="center">
